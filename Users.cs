...
namespace ims
{
    public partial class Users : Sample2
    {
        ...
        public override void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            if (phoneTxt.Text == "") { phoneErrorLable.Visible = true; } else { phoneErrorLable.Visible = false; }
            if (statusDD.SelectedIndex == -1) { statusErrorLable.Visible = true; } else { statusErrorLable.Visible = false; }

            if (nameErrorLable.Visible || usernameErrorLable.Visible || PassErrorLable.Visible || emailErrorLable.Visible || phoneErrorLable.Visible || statusErrorLable.Visible) 
            {
        ...
        public override void deleteBtn_Click(object sender, EventArgs e)
        {
            if(edit == 1)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    d.delete(userID, "st_deleteSupplier", "@id");
                    r.showUsers(dataGridView1, userIDGV, NameGV, UserNameGV, PassGV, EmailGV, PhoneGV, statusGV);
                }
